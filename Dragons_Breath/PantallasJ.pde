class PantallasJ extends Pantallas
{
  ...
  void display()
  {
    ...
    rect(x+v2, y, l, l);          // Fondos de las pantallas
    rect(x, y+v1, l, l);         
    rect(x+v1, y+v1, l, l);      
    ...
    rect(x+20,y+1109,750,400);
    rect(x+250,y+999,309,79);
    rect(x+1200,y+999,309,79);
    rect(x+1200,y+1299,309,79);
    rect(x+2030,y+90,500,350);
    ...
    text(" DRAGON'S ", x+250, y+60, 299, 99);           // Titulo del juego
    text(" BREATH ", x+275, y+160, 299, 99);   
