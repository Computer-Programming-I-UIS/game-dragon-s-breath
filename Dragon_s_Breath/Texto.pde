class PantallasT extends Pantallas
{
  ...
  int p1 = 1249,p2 = 550;       // PRUEBA (ELIMINAR DESPUES)
   ...
   void display()
   {
     ...
     textSize(32);
     textFont(texto);
     text(" DRAGON'S ",x+250,y+50,299,99);    // Letrero Dragon´s
     text(" BREATH ",x+250,y+150,299,99);   //         Breath
     text(" Controles ",x+200,y+999,399,99);   //         Controles       
     text(" Ajustes ",x+1149,y+999,399,99);  //         Ajustes
     text(" Creditos ",x+2098,y+999,399,99);  //         Creditos
     text(" ¿Continuar? ",x+2148,y+350,299,99);  //         ¿Continuar?
     textSize(24);
     text(" JUGAR ",j1,j2,399,99);      // Boton JUGAR
     text(" CONTROLES ",c1,c2,299,49);      //       CONTROLES
     text(" AJUSTES ",a1,a2,299,49);      //       AJUSTES
     text(" CREDITOS ",cr1,cr2,299,49);    //       CREDITOS
     text(" SALIR ",s1,s2,99,49);       //       SALIR
     text(" VOLVER ",vc1,vc2,199,49);    //       VOLVER en CONTROLES
     text(" VOLVER ",va1,va2,199,49);    //                 AJUSTES
     text(" VOLVER ",vcr1,vcr2,199,49);  //                 CREDITOS
     text(" VOLVER A INTENTARLO",r1,r2,299,49);      //       VOLVER A INTENTARLO
     text(" MENU PRINCIPAL",m1,m2,299,49);      //       MENU PRINCIPAL
