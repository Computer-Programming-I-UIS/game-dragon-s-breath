class PantallaI extends Pantalla
{
  ...
  int p1 = 1249,p2 = 550;       // PRUEBA (ELIMINAR DESPUES)
   ...
   PantallaI(int X, int Y, int L, int V1, int V2, PFont TEXTO)
           {
   ...
   void display()
   {
     ...
     rect(x,y,l,l);
     textFont(texto);
     rect(x+250,y+50,299,99);  // Dragon´s
     rect(x+250,y+150,299,99); // Breath
     /*fill(256);
     stroke(256);
     text(" DRAGON'S ",x+250,y+149);
     text(" BREATH ",x+250,y+249);
     fill(178,178,178);*/
     rect(x+200,y+300,399,99); // Boton J
     rect(x+250,y+450,299,49); // Boton C
     rect(x+250,y+550,299,49); // Boton A
     rect(x+250,y+650,299,49); // Boton CR
     rect(x+650,y+700,99,49);  // Boton S
   }
