class PantallaI extends Pantalla
{
  ...
  int p1 = 1249,p2 = 550;       // PRUEBA (ELIMINAR DESPUES)
   ...
   PantallaI(int X, int Y, int L, int V1, int V2)
           {
             super(X,Y,L,V1,V2); 
           }
   ...
   void display()
   {
     ...
     rect(x+200,y+350,399,99); // Boton J
     rect(x+250,y+500,299,49); // Boton C
     rect(x+250,y+600,299,49); // Boton A
     rect(x+250,y+700,299,49); // Boton CR
